...
var MarkerClusterer = function (_Component) {
  ...
  function MarkerClusterer() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = MarkerClusterer.__proto__ || (0, _getPrototypeOf2.default)(MarkerClusterer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _temp), (0, _possibleConstructorReturn3.default)(_this, _ret);
  }
  ...
  (0, _createClass3.default)(MarkerClusterer, [{
    ...
    value: function addMarker(marker) {
      var nodraw = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
