...
var GoogleMapLoader = function (_Component) {
  ...
  function GoogleMapLoader() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = GoogleMapLoader.__proto__ || (0, _getPrototypeOf2.default)(GoogleMapLoader)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      map: null
