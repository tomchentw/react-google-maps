...
"center", "heading", "mapTypeId", "streetView", "tilt", "zoom", "scrollwheel", "zoomControl", "streetViewControl", "mapTypeControl"];
...
var GoogleMapHolder = (function (_Component) {
  ...
  _createClass(GoogleMapHolder, [{
    ...
    value: function _createMap(domEl, mapProps) {
      // https://developers.google.com/maps/documentation/javascript/3.exp/reference#Map
      return new google.maps.Map(domEl, (0, _utilsComposeOptions2["default"])(mapProps, MAP_OPTIONS));
    }
  }, {
    key: "propTypes",
    value: {
