...
var ScriptjsLoader = function (_Component) {
  ...
  function ScriptjsLoader() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_Object$getPrototypeO = (0, _getPrototypeOf2.default)(ScriptjsLoader)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      isLoaded: false
