...
import { GoogleMap, Marker, Polyline, Polygon, InfoWindow } from "../../lib";
...
export default class GeojsonToComponents extends Component {
  ...
  handleMapZoomChanged = this.handleMapZoomChanged.bind(this);
  handleMarkerDragend = this.handleMarkerDragend.bind(this);
  handleMarkerClick = this.handleMarkerClick.bind(this);
  handlePolygonRightclick = this.handlePolygonRightclick.bind(this);
