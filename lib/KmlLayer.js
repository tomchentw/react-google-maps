...
var KmlLayer = (function (_Component) {
  ...
  _createClass(KmlLayer, [{
    ...
    value: function componentWillMount() {
      ...
      var kmlLayer = _creatorsKmlLayerCreator2["default"]._createKmlLayer(_extends({}, this.props, {
    ...
    value: function render() {
      ...
      if (this.state.kmlLayer) {
        return _react2["default"].createElement(
          ...
          _extends({ mapHolderRef: mapHolderRef, kmlLayer: this.state.kmlLayer }, this.props),
          this.props.children
        );
      } else {
    ...
    key: "contextTypes",
    value: {
      mapHolderRef: _react.PropTypes.instanceOf(_creatorsGoogleMapHolder2["default"])
    },
    enumerable: true
  }]);
