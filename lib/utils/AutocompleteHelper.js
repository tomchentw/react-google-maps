...
function createInputElement(props) {
  ...
  var component = (0, _reactDom.render)(
    _react2.default.createElement(
      "input",
      (0, _extends3.default)({}, props.inputProps || {}, {
...
function mountInputElementToControlPositionOnMap(
  inputEl,
  controlPosition,
  map
) {
...
function unmountInputElementFromControlPositionOnMap(
  index,
  controlPosition,
  map
) {
